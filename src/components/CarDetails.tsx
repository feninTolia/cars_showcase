...
const CarDetails = ({ isOpen, closeModal, car }: IProps) => {
  return (
    <>
            ...
            <div className=" flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel
                 ...
                 max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl
                  ...
                  <div className=" flex flex-1 flex-col gap-2">
                    ...
                    <div className=" mt-3 flex flex-wrap gap-4">
                      {Object.entries(car).map(([key, value]) => (
                        <div
                          key={key}
                          className=" flex justify-between w-full gap-5 text-right capitalize"
                        >
